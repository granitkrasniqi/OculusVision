            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Shto Antarin (Staf)</h4> </div>
                        <ol class="breadcrumb">
                            <li><a href="dashboard">Klinika</a></li>
                            <li class="active">Shto Antarin (Staf)</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                        ...
                        <div class="white-box">
                            ...
                            <c:choose>
                                <c:when test="${success == true}">
                                        <div class="alert alert-success">Antari u regjistrua me sukses</div>
                                </c:when>
                                <c:when test="${errors != null}">
                                        ...
                                        <form class="form-material form-horizontal" action="stafi" method="POST">
                                <input type="hidden" name="mainAction" value="mainShto" />
                                <div class="form-group">
                                    <label class="col-md-12" for="emri">Emri</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="emri" name="emri" class="form-control" value="${stafi.emri}" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="mbiemri">Mbiemri</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="mbiemri" name="mbiemri" class="form-control" value="${stafi.mbiemri}" required> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="kualifikimi">Kualifikimi</span>
                                    </label>
                                    <div class="col-md-12">
                                        <select id="kualifikimi" name="kualifikimi" class="form-control" required>
                                            <c:forEach items="${kualifikimet}" var="kual">
                                                <option value="${kual.id}"><c:out value="${kual}"/></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="klinika">Klinika</span>
                                    </label>
                                    <div class="col-md-12">
                                        <select id="kualifikimi" name="klinika" class="form-control" required>
                                            <c:forEach items="${klinikat}" var="klinika">
                                                <option value="${klinika.id}"><c:out value="${klinika}"/></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="rolistafit">Roli Antarit ( Staf )</span>
                                    </label>
                                    <div class="col-md-12">
                                        <select id="kualifikimi" name="rolistafit" class="form-control" required>
                                            <c:forEach items="${rolet}" var="roli">
                                                <option value="${roli.id}"><c:out value="${roli}"/></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
