    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        <a href="#" class="waves-effect"><img src="plugins/images/users/d1.jpg" alt="user-img" class="img-circle"> <span class="hide-menu">Dr. Emri Mbiemri<span class="fa arrow"></span></span>
                        </a>
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-user-md p-r-10"></i> <span class="hide-menu"> Mjekët <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="doctors.html">All Doctors</a> </li>
                            <li> <a href="<c:url value="/mjeku">
                                    <c:param name="action" value="shto"/>
                                    </c:url>">Shto Mjekun</a> </li>
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-inr p-r-10"></i> <span class="hide-menu"> Pagesat <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                    <div class="white-box">
                            <h3 class="box-title">Faqe per testim</h3>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2018 &copy; OculusVision </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
