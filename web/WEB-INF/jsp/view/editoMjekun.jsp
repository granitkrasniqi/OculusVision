...
--%>
<%--@elvariable id="mjeku" type="com.oculusvision.models.Mjeku"--%>
<%@page import="com.oculusvision.models.Mjeku"%>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edito Mjekun</h4> </div>
                        <ol class="breadcrumb">
                            <li><a href="index.html">Mjekët</a></li>
                            <li class="active">Edito Mjekun</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" action="mjeku" method="POST">
                                <input type="hidden" name="mainListo" value="mainEdito" />
                                <div class="form-group">
                                    <label class="col-md-12" for="emri">Emri</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="emri" name="emri" class="form-control" value="<c:out value="${mjeku.emri}" />" > </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="mbiemri">Mbiemri</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="mbiemri" name="mbiemri" class="form-control" value="<c:out value="${mjeku.mbiemri}" />" > </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="special" name="special" class="form-control" value="<c:out value="${mjeku.specializimi}" />" > </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Përshkrimi</label>
                                    <div class="col-md-12">
                                        <textarea class="form-control" rows="3" name="pershkrimi"  ><c:out value="${mjeku.pershkrimi}" /></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="url" name="url" class="form-control" value="<c:out value="${mjeku.webFaqja}"/>"> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="email" id="email-address" name="email-address" class="form-control" value="<c:out value="${mjeku.email}"/>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="telephone-nr">Numri i telefonit</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="telephone-nr" name="telephone-nr" class="form-control" data-mask="(999) 999-9999" value="<c:out value="${mjeku.nrTelefon}"/>" > </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="pwd">Fjalëkalimi</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="password" id="pwd" name="pwd" class="form-control" value="<c:out value="${mjeku.fjalekalimi}"/>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="cpwd">Konfirmimi i fjalëkalimit</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="password" id="cpwd" name="cpwd" class="form-control" value="<c:out value="${mjeku.fjalekalimi}"/>"> </div>
                                </div>
