                        ...
                        <div class="white-box">
                            ...
                            <c:choose>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="emri" name="emri" class="form-control" value="${pacienti.emri}" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="mbiemri">Mbiemri</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="mbiemri" name="mbiemri" class="form-control" value="${pacienti.mbiemri}" required> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="dataLindjes" name="dataLindjes" class="form-control mydatepicker" placeholder="dd/mm/yyyy" value="${pacienti.dataLindjes}" required> </div>
                                    </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="adresa">Adresa</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="adresa" name="adresa" class="form-control" value="${pacienti.adresa}" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="email">Email:</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="email" id="email" name="email" class="form-control" value="${pacienti.email}" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="numriTelefonit">Numri Telefonit:</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="numriTelefonit" name="numriTelefonit" class="form-control" value="${pacienti.numriTelefonit}" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Përshkrimi</label>
                                    <div class="col-md-12">
                                        <textarea class="form-control" rows="3" name="pershkrimi" required>${pacienti.pershkrim}</textarea>
                                    </div>
                                </div>
                                        <c:choose>
                                            <c:when test="${success == true}">
