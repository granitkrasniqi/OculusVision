...
<head>
    ...
    <title>OculusVision - Shto Rolet e stafit</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Shto rolet e stafit</h4> </div>
                        <ol class="breadcrumb">
                            <li><a href="dashboard">Klinika</a></li>
                            <li class="active">Shto rolet e stafit</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                        ...
                        <div class="white-box">
                            ...
                            <c:choose>
                                <c:when test="${success == true}">
                                        <div class="alert alert-success">Roli u regjistrua</div>
                                </c:when>
