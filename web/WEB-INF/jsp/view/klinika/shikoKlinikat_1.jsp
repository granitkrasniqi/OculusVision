                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Shiko Klinikat</h4> </div>
                        <ol class="breadcrumb">
                            <li><a href="dashboard">Klinika</a></li>
                            <li class="active">Shiko Klinikat</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <div class="row">
                        ...
                        <!-- .col -->
                        <c:choose>
                            <c:when test="${klinikat != null}">
                                <c:forEach items="${klinikat}" var="klinika">
                                    <div class="col-md-4 col-sm-4">
                                        <div class="white-box">
                                            <div class="row">
                                                <div class="col-md-8 col-sm-8">
                                                    <h3 class="box-title m-b-0">${klinika.emri}</h3>
                                                    <p> <address><abbr title="Adresa">A: </abbr>${klinika.adresa}</address>
                                                        <br/><br/>
                                                        <abbr title="Pershkrimi">P: </abbr>${klinika.pershkrimi}
                                                     </p>
                                                    <span>
                                                        <form action="klinika" method="get" class="d-inline-block" >
                                                            ...
                                                            <form action="klinika" method="post" class="d-inline-block">
