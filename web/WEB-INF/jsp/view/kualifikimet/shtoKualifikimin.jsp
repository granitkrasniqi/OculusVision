...
<head>
    ...
    <title>OculusVision - Shto Kualifikimin</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Shto Kualifikimin</h4> </div>
                        <ol class="breadcrumb">
                            <li><a href="dashboard">Klinika</a></li>
                            <li class="active">Shto Kualifikimin</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                        ...
                        <div class="white-box">
                            ...
                            <c:choose>
                                <c:when test="${success == true}">
                                        <div class="alert alert-success">Kualifikimin u regjistrua me sukses</div>
                                </c:when>
                            ...
                            <form class="form-material form-horizontal" action="kualifikimi" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="fakulteti" name="fakulteti" class="form-control" value="${fakulteti}" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="shteti">Shteti</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="shteti" name="shteti" class="form-control" value="${shteti}" required> </div>
                                </div>
                                        <c:choose>
                                            <c:when test="${success == true}">
